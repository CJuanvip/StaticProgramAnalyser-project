...
TEST_CASE("Test Interprocedural Affect Evaluator TC1") {
  ...
  verify(ans, mgr.getInterproceduralAffect());
}
TEST_CASE("Test Interprocedural Affect Evaluator TC2") {
...
TEST_CASE("Test Interprocedural Affect Evaluator TC4") {
  ...
  mgr.getInterproceduralAffect().dump();
  verify(ans, mgr.getInterproceduralAffect());
}

TEST_CASE("Test Interprocedural Affect Evaluator TC7") {
...
TEST_CASE("Test Interprocedural Affect Evaluator TC8") {
...
TEST_CASE("Test Interprocedural Affect Evaluator TC9") {
