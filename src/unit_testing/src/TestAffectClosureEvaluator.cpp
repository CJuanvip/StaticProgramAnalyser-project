...
TEST_CASE("Test Affect Closure Evaluator TC1") {
  ...
  verify(ans, mgr.getAffectClosure());
}

TEST_CASE("Test Affect Closure Evaluator TC2") {
...
TEST_CASE("Test Affect Closure Evaluator TC4") {
...
TEST_CASE("Test Affect Closure Evaluator TC7") {
...
TEST_CASE("Test Affect Closure Evaluator TC8") {
