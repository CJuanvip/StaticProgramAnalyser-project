...
TEST_CASE("Test Interprocedural Affect Closure Evaluator TC1") {
  ...
  verify(ans, mgr.getInterproceduralAffectClosure());
}

TEST_CASE("Test Interprocedural Affect Closure Evaluator TC2") {
...
TEST_CASE("Test Interprocedural Affect Closure Evaluator TC4") {
  ...
  mgr.getInterproceduralAffectClosure().dump();
  verify(ans, mgr.getInterproceduralAffectClosure());
}

TEST_CASE("Test Interprocedural Affect Closure Evaluator TC7") {
...
TEST_CASE("Test Interprocedural Affect Closure Evaluator TC8") {
...
TEST_CASE("Test Interprocedural Affect Closure Evaluator TC9") {
  auto program = buildTestCase9();
  PKBTableManager mgr;
  CallGraph callGraph;
  ControlFlowGraph cfg;
  ModifyProcessor modifyProcessor;
